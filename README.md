...
The current stable release is **v19.3.0**. Checksums are published beside the standalone executables.
...
| Debian / Ubuntu | DEB package | [ispotify_19.3.0_amd64.deb](https://github.com/RubinLabs26/ISpotify/releases/download/v19.3.0/ispotify_19.3.0_amd64.deb) |
