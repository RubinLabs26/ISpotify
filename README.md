...
The current stable release is **v19.4.3**. Checksums are published beside the standalone executables.
...
| Debian / Ubuntu | DEB package | [ispotify_19.4.3_amd64.deb](https://github.com/RubinLabs26/ISpotify/releases/download/v19.4.3/ispotify_19.4.3_amd64.deb) |
