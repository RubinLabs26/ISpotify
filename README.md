...
The current stable release is **v19.1.3**. Checksums are published beside the standalone executables.
...
| Debian / Ubuntu | DEB package | [ispotify_19.1.3_amd64.deb](https://github.com/RubinLabs26/ISpotify/releases/download/v19.1.3/ispotify_19.1.3_amd64.deb) |
